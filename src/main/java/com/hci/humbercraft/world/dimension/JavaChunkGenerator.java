...
public class JavaChunkGenerator extends NoiseChunkGenerator<JavaGenSettings> {
   ...
   public JavaChunkGenerator(IWorld worldIn, BiomeProvider provider, JavaGenSettings settingsIn) {
