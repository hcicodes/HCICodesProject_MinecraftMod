package com.hci.humbercraft.client.gui;
...
public class JavacRefineryScreen extends ContainerScreen<JavacRefineryContainer>{
	private static final ResourceLocation TEXTURE = new ResourceLocation(HumberCraft.MOD_ID,
			"textures/gui/example_furnace.png");

	public JavacRefineryScreen(JavacRefineryContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
